export default {
  'menu.ucenter': 'User Center',
  'menu.ucenter.user': 'User',
  'menu.ucenter.user.list': 'User List',
  'menu.list.searchTable': 'Set meal List',
  'menu.park.parkingRecord': 'Parking Record',
  'menu.parkingRecord.searchTable': 'Parking Record List',

  'menu.ucenter.ad': 'Advertisement Management',
  'menu.ucenter.ad.adlist.': 'Advertising List',

  'searchTable.form.parkName': 'Park Name',
  'searchTable.form.parkName.placeholder': 'Please enter Park Name',
