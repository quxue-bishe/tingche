  ...
  <div class="container">
    <Breadcrumb
      :items="[
        ...
        'menu.pay.internetofthings.cartype',
      ]"
    />
    <a-card class="general-card" :title="$t('menu.pay.internetofthings.cartype')">
      <a-row>
        <a-col :flex="1">
          <a-form
            :model="formModel"
...
<script lang="ts" setup>
  ...
  import { getCarTypeListByQuery, carTypeDelete } from '@/api/park';
