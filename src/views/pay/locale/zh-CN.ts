export default {
  'menu.pay': '支付',
  'menu.pay.coupon': '优惠券',
  'menu.pay.coupon.couponlist': '使用记录',
  'menu.pay.coupon.activitylis': '活动列表',
  'menu.pay.userPaymentAgency.wechatmerchantapplicationlist': '收款账号申请',
  'menu.pay.order': '订单',
  'menu.pay.order.list': '订单列表',
  'menu.account': '资金',
  'menu.pay.bank':'银行',
  'menu.pay.bank.list':'银行列表',
  'menu.pay.bank.bankBranchList': '支行列表',
  'menu.account.list': '资金账户',
  'menu.scoretype': '积分',
  'menu.scoretype.list': '积分类型',
  'menu.pay.userPaymentAgency': '收款账号',
  'menu.pay.userPaymentAgency.list': '收款账号列表',
