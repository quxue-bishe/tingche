...
<script lang="ts" setup>
  ...
  onMounted(() => {
    if (localStorage.getItem('government-SuperManagement')) {
      // @ts-ignore
      formData.value = JSON.parse(localStorage.getItem('government-SuperManagement'));
    }
  });
  ...
  const onNext = () => {
    formRef.value.validate((valid: any) => {
      ...
      // @ts-ignore
      localStorage.setItem('government-SuperManagement', JSON.stringify(formData.value));
      const paramsInfo = {
        bank_account_info: JSON.parse(localStorage.getItem('government-Settlement')),
        subject_info: JSON.parse(localStorage.getItem('government-Subject')),
        business_info: JSON.parse(localStorage.getItem('government-Manage')),
        settlement_info: JSON.parse(localStorage.getItem('government-Industry')),
        contact_info: JSON.parse(localStorage.getItem('government-SuperManagement')),
      };
      console.log(
