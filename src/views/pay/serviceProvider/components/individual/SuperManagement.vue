...
<script lang="ts" setup>
  ...
  onMounted(() => {
    if (localStorage.getItem('individual-SuperManagement')) {
      // @ts-ignore
      formData.value = JSON.parse(localStorage.getItem('individual-SuperManagement'));
    }
  });
  ...
  const onNext = () => {
    formRef.value.validate(async (valid: any) => {
      ...
      // @ts-ignore
      localStorage.setItem('individual-SuperManagement', JSON.stringify(formData.value));
      const paramsInfo = {
        bank_account_info: JSON.parse(localStorage.getItem('individual-Settlement')),
        subject_info: JSON.parse(localStorage.getItem('individual-Subject')),
        business_info: JSON.parse(localStorage.getItem('individual-Manage')),
        settlement_info: JSON.parse(localStorage.getItem('individual-Industry')),
        contact_info: JSON.parse(localStorage.getItem('individual-SuperManagement')),
      };
